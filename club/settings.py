...
SECRET_KEY = 'django-insecure-^fvlevvtn80-dou#@f9ijpe6d@%*url^8q_mk#ursqv74jr@!q'
...
# MEDIA files (uploads like quiz images)
MEDIA_URL = '/media/'  # URL used in templates: {{ quiz.image.url }}
